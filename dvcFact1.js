...
var connectionString = 'HostName=rodIndustries.azure-devices.net;DeviceId=Factory1;SharedAccessKey=N6JIFIzkSv6EkNYxPl4UKQuFO+BPQrjuSc0V68MKJeI=';
...
var connectCallback = function(err) {
    ...
    if (err) {
        ...
        var data = JSON.stringify({ site: 'Factory1', temperature: temp, humidity: humidity, movement: movement });
        ...
        message.properties.add("site", "Factory1");                

...
var connectionString = 'HostName=rodIndustries.azure-devices.net;DeviceId=Factory2;SharedAccessKey=2/tmSrXDlVwum27iLlSM01xw9lxYDD0Jq9LQynp5W1Y=';
...
var connectCallback = function(err) {
    ...
    if (err) {
        ...
        var data = JSON.stringify({ site: 'Factory2', temperature: temp, humidity: humidity, movement: movement });
        ...
        message.properties.add("site", "Factory2");                
